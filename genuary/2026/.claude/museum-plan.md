...
| 2026-01-27 | 27 | SEEKING: 3D mycelium network growing through space, seeking invisible nutrient sources. Each filament tip senses gradients, turns toward resources, forks when abundant, withers when trapped. Distributed intelligence—ten thousand small decisions. ARCHITECTURAL: Grows across the glass walls of the Transparency Chamber. Visitors see each other through the network. After Physarum polycephalum, the slime mold that solved the Tokyo rail system. |
| 2026-01-28 | 28 | PANEL: A control panel for nothing. Push buttons, toggle switches, rotary knobs, sliders, VU meters, LED indicators—all fully functional, all connected to nothing. Pure HTML + CSS, no canvas. INTERACTIVE: Freestanding terminal in Main Gallery or the "interactive console" in Evolution Lab. The satisfaction of feedback without function. After NASA mission control and analog synthesizers. |
| 2026-01-29 | 29 | TANK: Three parallel evolution tanks with different selection pressures. PREDATORS tank breeds speed. SCARCITY tank breeds efficiency. OBSTACLES tank breeds navigation. Each creature's genome visible as colored ring segments (speed=red, size=blue, sensing=green, metabolism=yellow, aggression=purple). Watch populations diverge across generations. INTERACTIVE: Main feature of Evolution Lab. Three tank displays on pedestals. Visitors observe parallel experiments. Dead specimens fade as ghosts. Emergency repopulation prevents extinction. After Karl Sims' Evolved Virtual Creatures and Scott Draves' Electric Sheep. |
| 2026-01-30 | 30 | ASSERTION: Shapes that lie about themselves. Each shape asserts a property ("I am blue," "I am still," "I am a circle") while conspicuously contradicting it. The red shape says it's blue. The bouncing shape says it's still. The code works perfectly—the bug is in the specification. AMBIENT: Distributed throughout Recursion Room as environmental labels that lie. False placards, incorrect room names, misleading signs. The "bug/feature" theme pervades the space. After Rosa Menkman's Glitch Studies Manifesto and Bob Ross's "happy accidents." |
| 2026-01-31 | 31 | TERMINUS: A raymarched infinite corridor. Pure GLSL—no geometry, no mesh, every pixel calculated from distance functions. The hallway stretches to infinity; a door is visible at the vanishing point but never arrives no matter how far you walk. WASD navigation. ARCHITECTURAL: This IS architecture, not art on walls. Could replace Day 17's geometry-based hallway as the museum's entrance, or serve as the final exhibit—the door at the end of everything that leads to infinity. The ending that never ends. Placard: "The corridor has no end. Each step forward, it recalculates itself. The walls are distance functions. The light is trigonometry. Walk forward. Keep walking. You'll never get there." After Inigo Quilez (raymarching SDFs) and The Book of Shaders. |
